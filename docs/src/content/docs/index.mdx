...
<CardGrid stagger>
  <Card title="Specialized for ClickHouse" icon="document">
    Purpose-built interface that leverages ClickHouse's columnar architecture and
    analytical capabilities for log exploration.
  </Card>
  ...
  <Card title="Schema Agnostic" icon="setting">
    Works with any ClickHouse log table structure. No forced migrations or schema
