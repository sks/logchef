import{a4 as rr,a5 as W,B as z,X as ve,a6 as ae,a7 as Yn,m as h,a8 as Q,a9 as Qn,aa as eo,ab as to,ac as Pe,ad as no,ae as Mt,G as st,o as d,c as b,e as I,af as on,ag as ir,ah as rn,ai as oo,aj as de,ak as be,al as ge,k as ee,l as wt,am as ke,g as Fe,W as U,d as x,an as ar,a as g,ao as lr,b as k,ap as Ct,p as R,F as D,I as q,v as J,aq as F,h as X,ar as sr,as as ur,at as ye,au as ro,j as St,R as dr,S as io,Q as ao,Y as cr,av as ut,aw as an,ax as Et,q as le,y as L,w as E,T as lo,D as Pt,t as Z,A as Ae,x as se,z as xe,r as T,ay as ln,az as yt,_ as pr,aA as ht,s as so,aB as fr,aC as sn,aD as un,aE as Gt,aF as Nt,P as uo,aG as kt,a0 as Rt,V as vt,aH as Ot,Z as dn,aI as cn,aJ as pn,aK as Tt,U as Ee,aL as hr,aM as mr,aN as br,aO as gr,aP as fn}from"./index-BU8Nkwk6.js";var mt={};function Ut(n="pui_id_"){return mt.hasOwnProperty(n)||(mt[n]=0),mt[n]++,`${n}${mt[n]}`}function yr(){let n=[];const e=(a,l,u=999)=>{const s=i(a,l,u),c=s.value+(s.key===a?0:u)+1;return n.push({key:a,value:c}),c},t=a=>{n=n.filter(l=>l.value!==a)},r=(a,l)=>i(a).value,i=(a,l,u=0)=>[...n].reverse().find(s=>!0)||{key:a,value:u},o=a=>a&&parseInt(a.style.zIndex,10)||0;return{get:o,set:(a,l,u)=>{l&&(l.style.zIndex=String(e(a,!0,u)))},clear:a=>{a&&(t(o(a)),a.style.zIndex="")},getCurrent:a=>r(a)}}var Ie=yr();const Le="/api";function vr(n,e){return Array.from({length:Math.ceil(n.length/e)},(t,r)=>n.slice(r*e,r*e+e))}const fu={async getLogs(n,e,t){const r=new URLSearchParams;r.append("limit",e.limit.toString()),r.append("offset",e.offset.toString()),r.append("start_time",e.start_time),r.append("end_time",e.end_time),e.search_query&&r.append("search",e.search_query),e.severity_text&&r.append("severity",e.severity_text);const i=await fetch(`${Le}/logs/${n}?${r.toString()}`,{method:"GET",headers:{"Content-Type":"application/json"},signal:t});if(!i.ok)throw new Error("Failed to fetch logs");const o=await i.json();return{...o.data,chunks:vr(o.data.logs||[],1e3)}},async fetchSources(){const n=await fetch(`${Le}/sources`);if(!n.ok)throw new Error("Failed to fetch sources");return(await n.json()).data},async deleteSource(n){const e=await fetch(`${Le}/sources/${n}`,{method:"DELETE",headers:{"Content-Type":"application/json"}}),t=await e.text();if(!e.ok){const r=t?JSON.parse(t):{};throw new Error(r.message||"Failed to delete source")}return t},async updateSourceTTL(n,e){const t=await fetch(`${Le}/sources/${n}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({ttl_days:e})});if(!t.ok)throw new Error("Failed to update TTL");return t.json()},async getLogSchema(n,e,t){const r=new URLSearchParams;e!=null&&e.start_time&&r.append("start_time",e.start_time),e!=null&&e.end_time&&r.append("end_time",e.end_time);const i=await fetch(`${Le}/logs/${n}/schema?${r.toString()}`,{headers:{"Content-Type":"application/json"},signal:t});if(!i.ok)throw new Error("Failed to fetch schema");return(await i.json()).data}};function je(n){"@babel/helpers - typeof";return je=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},je(n)}function wr(n,e){if(!(n instanceof e))throw new TypeError("Cannot call a class as a function")}function Cr(n,e){for(var t=0;t<e.length;t++){var r=e[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(n,kr(r.key),r)}}function Sr(n,e,t){return e&&Cr(n.prototype,e),Object.defineProperty(n,"prototype",{writable:!1}),n}function kr(n){var e=Pr(n,"string");return je(e)=="symbol"?e:e+""}function Pr(n,e){if(je(n)!="object"||!n)return n;var t=n[Symbol.toPrimitive];if(t!==void 0){var r=t.call(n,e);if(je(r)!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(n)}var co=function(){function n(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:function(){};wr(this,n),this.element=e,this.listener=t}return Sr(n,[{key:"bindScrollListener",value:function(){this.scrollableParents=rr(this.element);for(var t=0;t<this.scrollableParents.length;t++)this.scrollableParents[t].addEventListener("scroll",this.listener)}},{key:"unbindScrollListener",value:function(){if(this.scrollableParents)for(var t=0;t<this.scrollableParents.length;t++)this.scrollableParents[t].removeEventListener("scroll",this.listener)}},{key:"destroy",value:function(){this.unbindScrollListener(),this.element=null,this.listener=null,this.scrollableParents=null}}])}();function Ve(n){"@babel/helpers - typeof";return Ve=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Ve(n)}function xr(n){return Tr(n)||Or(n)||Rr(n)||Ir()}function Ir(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
